...
REGION_MODE = "bd" # bd identik dengan id di sistem paket
    ...
    while True:
        try:
            ...
            while time.time() < match_end:
                ...
                if int(time.time()) % 6 == 0: # Spam Skill Tiap 6s
...
async def MaiiiinE():
    ...
    print(f"🚀 [ONLINE] UID: {auth_res.account_uid}")
